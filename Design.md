...
Web Scraping from jobright -> taking the technologies that are on the qulaifications/Requirements -> display a project desgin that can be done to for each job application. 
## Resume Section
